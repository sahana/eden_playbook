...
vserver!#!match!domain!1 = {{ sitename }}
...
vserver!#!rule!500!document_root = /home/demo/applications/eden/static
...
vserver!#!rule!400!document_root = /home/demo/applications/eden/static/img
...
vserver!#!rule!300!document_root = /home/demo/applications/eden/static
...
source!#!group = web2py
source!#!host = 127.0.0.1:59027
source!#!interpreter = /usr/local/bin/uwsgi -s 127.0.0.1:59027 -x /home/demo/uwsgi.xml
source!#!nick = uWSGI #
source!#!timeout = 1000
source!#!type = host
source!#!user = web2py
